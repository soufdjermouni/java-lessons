...
public class FunctionPredicateExample {
    ...
    public static void main(String[] args) {
        ...
        lambda qui vérifie si un entier est pair en utilisant l'opérateur modulo %. Nous avons ensuite appelé la méthode test() de cette instance pour vérifier si l'entier 4 est pair (ce qui renvoie true) et si l'entier 5 est pair (ce qui renvoie false).
         */
